 ...
 * @copyright	Copyright (c) 2006 - 2011 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_Writer_PDF_DomPDF extends PHPExcel_Writer_HTML implements PHPExcel_Writer_IWriter {
	/**
	...
	private static $_paperSizes = array(
		...
		PHPExcel_Worksheet_PageSetup::PAPERSIZE_TABLOID							=> 'tabloid',				//	(11 in. by 17 in.)
		PHPExcel_Worksheet_PageSetup::PAPERSIZE_LEDGER							=> 'ledger',				//	(17 in. by 11 in.)
	...
	public function save($pFilename = null) {
		...
		if (!is_null($this->_orientation)) {
			$orientation = ($this->_orientation == PHPExcel_Worksheet_PageSetup::ORIENTATION_DEFAULT) ?
				PHPExcel_Worksheet_PageSetup::ORIENTATION_PORTRAIT : $this->_orientation;
		}
		//	Override Paper Size
