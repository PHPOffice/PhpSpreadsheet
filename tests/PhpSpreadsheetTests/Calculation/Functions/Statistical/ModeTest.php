...
class ModeTest extends TestCase
{
     ...
     * @param string $str
     */
    public function testMODE($expectedResult, $str)
    {
    ...
    public function providerMODE()
    {
        return require 'data/Calculation/Statistical/MODE.php';
    }

    public function testMODENoArgs()
    {
