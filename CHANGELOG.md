...
- Fixed copying a spreadsheet: sheets are now copied from source to target, instead of being moved [#1538](https://github.com/PHPOffice/PhpSpreadsheet/pull/1538)
