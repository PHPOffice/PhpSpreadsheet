...
class BesselJ
{
    ...
    private static function besselJ0(float $x): float
    {
        ...
        if ($ax < 8.0) {
            $y = $x * $x;
            $ans1 = 57_568_490_574.0 + $y * (-13_362_590_354.0 + $y * (651_619_640.7 + $y * (-11_214_424.18 + $y
                            * (77392.33017 + $y * (-184.9052456)))));
            $ans2 = 57_568_490_411.0 + $y * (1_029_532_985.0 + $y * (9_494_680.718 + $y * (59272.64853 + $y
                            * (267.8532712 + $y * 1.0))));
    ...
    private static function besselJ1(float $x): float
    {
        ...
        if ($ax < 8.0) {
            $y = $x * $x;
            $ans1 = $x * (72_362_614_232.0 + $y * (-7_895_059_235.0 + $y * (242_396_853.1 + $y
                            * (-2_972_611.439 + $y * (15704.48260 + $y * (-30.16036606))))));
            $ans2 = 144_725_228_442.0 + $y * (2_300_535_178.0 + $y * (18_583_304.74 + $y * (99447.43394 + $y
                            * (376.9991397 + $y * 1.0))));
