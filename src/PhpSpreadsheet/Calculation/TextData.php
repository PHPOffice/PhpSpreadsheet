...
class TextData
{
     ...
     *
     * @param string $stringValue The string to convert.
     *
     * @return string The converted string.
     */
    public static function ASC(string $stringValue): string
    {
        $stringValue = Functions::flattenSingleValue($stringValue);
        ...
        if (!is_string($stringValue) && !is_numeric($stringValue)) {
            // Behavior for non-string/non-numeric types can be debated.
            // Excel's ASC function typically expects text. Returning as is or #VALUE! are options.
            // For simplicity here, casting to string, but Functions::VALUE() might be more Excel-like for unsupported types.
        ...
        return $stringValue; // Default fallback: return original string.
    }
