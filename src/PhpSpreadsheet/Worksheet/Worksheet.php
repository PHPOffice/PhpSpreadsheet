        ...
        if ($validate) {
            ...
            if ($this->parent) {
                ...
                if ($this->parent->sheetNameExists($pValue)) {
                    ...
                    if (Shared\StringHelper::countCharacters($pValue) > (self::SHEET_TITLE_MAXIMUM_LENGTH - 1)) {
                        $pValue = Shared\StringHelper::substring($pValue, 0, (self::SHEET_TITLE_MAXIMUM_LENGTH - 1));
                    }
                    $i = 1;
