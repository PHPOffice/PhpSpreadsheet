...
class Xlsx extends BaseReader
{
    ...
    private function readProtection(Spreadsheet $excel, SimpleXMLElement $xmlWorkbook): void
    {
        ...
        $excel->getSecurity()->setRevisionsPassword(self::getPasswordValue($xmlWorkbook->workbookProtection, 'revisionsPassword'), true);
        $excel->getSecurity()->setWorkbookPassword(self::getPasswordValue($xmlWorkbook->workbookProtection, 'workbookPassword'), true);
    }
