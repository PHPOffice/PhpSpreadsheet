 ...
 */
abstract class Core extends \PhpSpreadsheet\Writer\HTML
{
    /**
    ...
    public function __construct(\PhpSpreadsheet\Spreadsheet $spreadsheet)
    {
        ...
        $this->tempDir = \PhpSpreadsheet\Shared\File::sysGetTempDir();
    }
    ...
    protected function prepareForSave($pFilename = null)
    {
        ...
        $this->saveArrayReturnType = \PhpSpreadsheet\Calculation::getArrayReturnType();
