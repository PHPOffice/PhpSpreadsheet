...
use PhpOffice\PhpSpreadsheet\Shared\Xls as Xls2;
use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Worksheet\BaseDrawing;
use PhpOffice\PhpSpreadsheet\Worksheet\Drawing as Drawing2;
...
class Xls extends BaseWriter implements IWriter
{
    ...
    public function save($pFilename = null)
    {
        ...
        $OLE = new \PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\File(OLE::ascToUcs($workbookStreamName));
    ...
    private function buildWorksheetEschers()
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = Xls2::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
    ...
    private function buildWorkbookEscher()
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                if ($drawing instanceof Drawing2) {
