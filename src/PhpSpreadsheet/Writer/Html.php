...
class Html extends BaseWriter
{
    ...
    {
        if ($lineEnding != "\n" && $lineEnding !== "\r\n") {
            throw new SpreadsheetException('Line ending must be \n (Unix) or \r\n (Windows)');
        }
    ...
    private function generateTableTagInline(Worksheet $worksheet, string $id): string
    {
        ...
        if ($viewgrid && $prntgrid) {
            $html = "    <table border='1' cellpadding='1'$rtl$dataPrint $id cellspacing='1' style='$style' class='gridlines gridlinesp$float'>" . $this->lineEnding;
        } elseif ($viewgrid) {
            $html = "    <table border='0' cellpadding='0'$rtl$dataPrint $id cellspacing='0' style='$style' class='gridlines$float'>" . $this->lineEnding;
        } elseif ($prntgrid) {
            $html = "    <table border='0' cellpadding='0'$rtl$dataPrint $id cellspacing='0' style='$style' class='gridlinesp$float'>" . $this->lineEnding;
        } elseif ($float === '') {
            $html = "    <table border='0' cellpadding='1'$rtl$dataPrint $id cellspacing='0' style='$style'>" . $this->lineEnding;
        } else {
            $html = "    <table border='0' cellpadding='1'$rtl$dataPrint $id cellspacing='0' style='$style' class='$float'>" . $this->lineEnding;
        }
